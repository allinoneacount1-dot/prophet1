...
function Profile() {
  ...
  return (
    <>
      <PageHeader
        eyebrow="Profile"
        title="Your Prophet Identity"
        description="Reputation, scores, and on-chain history aggregated across every connected chain."
      />

      <GlassCard glow className="overflow-hidden">
        <div className="flex flex-col gap-6 md:flex-row md:items-center">
          <div className="relative h-20 w-20 shrink-0 rounded-2xl bg-background/40 backdrop-blur overflow-hidden">
            <img 
          ...
          <div className="flex-1">
            ...
            <div className="font-mono text-xs text-muted-foreground">
              {address ? shortAddr(address) : "Not connected"} {wallet && `· ${wallet}`}
            </div>
            ...
            <div className="mt-3">
              ...
              <div className="mt-1 h-2 rounded-full bg-surface-2">
                <div
                  className="h-full rounded-full bg-[linear-gradient(135deg,var(--prophet),var(--chain))]"
