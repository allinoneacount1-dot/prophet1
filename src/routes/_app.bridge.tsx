        ...
        <GlassCard glow>
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-center">
              <div className="grid h-9 w-9 place-items-center rounded-full border border-border bg-surface-1">
            ...
            <div className="rounded-xl border border-border bg-surface-1/40 p-3">
              ...
              <div className="mt-2 flex items-center gap-2">
                ...
                <div className="flex-1 text-right text-2xl font-semibold tabular-nums text-[color:var(--chain)]">
                  {(parseFloat(amt || "0") * 0.998).toFixed(2)}
                </div>
                <span className="text-sm text-muted-foreground">USDC</span>
              </div>
            </div>
            <div className="rounded-lg bg-surface-1/40 p-3 text-xs text-muted-foreground">
              <div className="flex justify-between">
                <span>Route</span>
                <span className="text-foreground">Wormhole · 2 hops</span>
              </div>
              <div className="mt-1 flex justify-between">
                <span>Estimated time</span>
                <span className="text-foreground">~ 38s</span>
              </div>
              <div className="mt-1 flex justify-between">
                <span>Fee</span>
            ...
            <button
              onClick={() =>
                toast.success("Bridge initiated", {
                  description: "Watching for finality on destination chain.",
                })
              }
          ...
          <ul className="divide-y divide-border text-sm">
            {[
              ...
              <li key={i} className="flex items-center justify-between py-3">
                ...
                <span
                  className={`text-xs ${b.s === "Complete" ? "text-[color:var(--success)]" : "text-[color:var(--warning)]"}`}
                >
                  {b.s}
                </span>
              </li>
